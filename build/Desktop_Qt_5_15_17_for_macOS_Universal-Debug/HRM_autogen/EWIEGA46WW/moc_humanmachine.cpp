...
QT_MOC_LITERAL(1, 13, 17), // "rotationCompleted"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 10), // "rotateStep"
QT_MOC_LITERAL(4, 43, 15) // "moveMachineStep"

    },
    "Humanmachine\0rotationCompleted\0\0"
    "rotateStep\0moveMachineStep"
};
...
void Humanmachine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->rotationCompleted(); break;
        case 1: _t->rotateStep(); break;
        case 2: _t->moveMachineStep(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Humanmachine::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Humanmachine::rotationCompleted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Humanmachine::rotationCompleted()
{

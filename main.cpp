...
int main(int argc, char *argv[]) {
    ...
    games.push_back(Game(std::vector<std::string>{"1","2","3","4"},std::vector<std::string>{"inbox", "outbox", "copyfrom", "copyto", "add", "sub", "jump", "jumpifzero" , "hand+" , "hand-" , "jumpifpos" , "jumpifneg" , "copyifneg" , "copyifpos"},std::vector<std::string>{"10"},3,1,"第四关\n没有描述"));
